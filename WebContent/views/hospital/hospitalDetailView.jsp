...
<head>
<meta charset="UTF-8">
<title>Petist - 동물병원 상세페이지 [<%= hi.getHospName() %>]</title>
...
<body>
	...
	<div class="content">
		...
		<div class="content_2">
			...
			<table class="common-area" align="center">
				...
				<tr>
					<td colspan="2" style="padding: 0;">
						...
						<div id="review">
							<a href="<%= contextPath %>/review.ho?hno=<%= hi.getHospNo() %>&cpage=<%= currentPage %>&crpage=1">리뷰(<%= hi.getReviewCount() %>)</a>
						</div>
					</td>
				</tr>
			</table>
			...
			<div align="center">
				<br><br>
				<a href="<%= contextPath %>/list.ho?cpage=<%= currentPage %>" class="btn btn-sm btn-info"> 목록으로 돌아가기 </a>
			</div>
