...
<%
	ArrayList<Inquiry> rlist = (ArrayList<Inquiry>)request.getAttribute("rlist");
	PageInfo pi = (PageInfo)request.getAttribute("pi");
	Inquiry id = (Inquiry)request.getAttribute("id");
...
<body>
   ...
   <div class="content" style="min-height:700px;">
            ...
            <li>
               <ul>
                 <li>
                  ...
                  <li>
                     <a href="<%= contextPath %>/list.re?cpage=1" style="font-weight:bold">신고내역</a>
                  </li>
                  <li>
      ...
      <div class="content_2">
            <table id="reachMem">
               <tr>
                  <th width="730px">
                     ...
                     <button type="submit" onclick="searchId();">검색</button>
                  </th>
            ...
            <div class="report">전체 신고내역</div>
            <table id="report" class="list-area">
               <thead>
                  <tr>
                     <th width="60px">선택</th>
                     <th width="70px">번호</th>
        ...
        <div align="center" class="paging-area">
            <% if(currentPage != 1) { %> <!-- 페이징바에서 <를 담당 -->
               <button class="btnpage" onclick="location.href='<%= contextPath %>/list.re?cpage=<%= currentPage - 1 %>'"> &lt; </button>
            <% } %>
            
            <% for(int i = startPage; i<=endPage; i++) { %>
               <% if(i != currentPage) { %>   
               	  <button class="btnpage" onclick="location.href='<%= contextPath %>/list.re?cpage=<%= i %>'"><%= i %></button>
               <% } else { %>
